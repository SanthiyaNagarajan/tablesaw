...
public class InterpolatorTest {
  ...
  public static double[] strToDoubleArray(String input) {
    String[] chunks =
        input.replaceAll("\\[", "").replaceAll("\\]", "").replaceAll("\\s", "").split(",");
  ...
  @CsvSource({
    ...
    // array size = n ( n > 1), with 1 missing value placed at the beginning, middle, and end of the
    // array
  ...
  public void testParametrized(String partition, String data, String expected) {
    double[] inputData = tech.tablesaw.interpolation.InterpolatorTest.strToDoubleArray(data);
    double[] expectedOutput =
        tech.tablesaw.interpolation.InterpolatorTest.strToDoubleArray(expected);
